...
- (void)sharedSetup {
    UACircularProgressView * uac = [[UACircularProgressView alloc] initWithFrame:self.bounds];
    uac.shapeLayer.fillColor = [UIColor clearColor].CGColor;
    [self addSubview:uac];
    uac.shapeLayer.strokeColor = [CommonTools getColorWithHexString:@"f5f5f5"].CGColor;
    [uac updateProgress:1];
    uac.shapeLayer.lineWidth = 10.0f;
...
- (void)tintColorDidChange {
    ...
    self.progressView.shapeLayer.borderColor = [CommonTools getColorWithHexString:@"f5f5f5"].CGColor;
}
...
- (UIBezierPath *)layoutPath {
	...
	CGFloat borderWidth = self.shapeLayer.borderWidth-4.0f;
