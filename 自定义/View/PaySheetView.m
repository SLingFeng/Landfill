...
-(void)setView {
    ...
    title.font = [CommonTools getPXFontSize:32];
    ...
    for (int i=0; i<titles.count; i++) {
        ...
        label.tag = i+30;
        label.textColor = [CommonTools getColorWithHexString:@"333333"];
        label.font = [CommonTools getPXFontSize:32];
...
-(void)drawRect:(CGRect)rect {
    [super drawRect:rect];
    [CommonTools drawLineToY:50 spaceForRightAndLetf:0 color:[CommonTools getColorWithHexString:@"c9c9c9"] lineW:0.5];
    [CommonTools drawLineToY:101 spaceForRightAndLetf:10 color:[CommonTools getColorWithHexString:@"c9c9c9"] lineW:0.5];
    [CommonTools drawLineToY:151 spaceForRightAndLetf:10 color:[CommonTools getColorWithHexString:@"c9c9c9"] lineW:0.5];
}
