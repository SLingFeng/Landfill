...
#pragma mark - 四类个性化设置，这些参数都可以不传，此时会走默认设置
    ...
    // 2. 在这里设置imagePickerVc的外观
     imagePickerVc.navigationBar.barTintColor = [CommonTools getNavBarColor];
...
#define push @#clang diagnostic pop
        ...
        alert.tag = 1;
        [alert show];
    } else if (authStatus == AVAuthorizationStatusAuthorized || authStatus == AVAuthorizationStatusNotDetermined) { // 调用相机
